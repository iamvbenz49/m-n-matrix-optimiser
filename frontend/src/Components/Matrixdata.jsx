...
const Matrixdata = (props) => {
  ...
  const getResultBoxStyle = () => {
    return {"marginTop":"20px","backgroundColor":"rgb(231, 76, 60)","color":"rgb(255, 255, 255)","padding":"10px 20px","borderRadius":"10px","boxShadow":"rgba(0, 0, 0, 0.1) 0px 0px 10px","textAlign":"center","fontSize":"24px","fontWeight":"bold","textTransform":"uppercase","letterSpacing":"1px","top":"15rem","position":"relative"}
  };
